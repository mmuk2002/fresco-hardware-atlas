...
| 3:05–3:45 | Show the tests/evaluation report and corpus audit. Discuss the frozen eight-family holdout: 14/14 sets, 126/126 expected rows, 123/126 exact whole rows, and zero manufacturer/finish swaps. Show the 17/17 heading and 126/126 component-location checks. Scores are sample-specific; whole-corpus accuracy is not established. |
